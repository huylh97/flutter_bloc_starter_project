...
class UserModel {
  ...
  final String? token;
  final String? hawker_merchantToken;
  final int followers;
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      ...
      hawker_merchantToken: user['access_token'],
  ...
  factory UserModel.fromDatabase(Map<String, dynamic> json) {
    return UserModel(
      ...
      token: json['token'],
      hawker_merchantToken: json['hawker_merchantToken'],
  ...
  Map<String, dynamic> toDatabase() {
    return {
      ...
      "country": country,
      "token": token,
      "hawker_merchantToken": hawker_merchantToken,
      "followers": followers,
