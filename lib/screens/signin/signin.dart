...
import 'package:hawker_merchant/models/model.dart';
import 'package:hawker_merchant/utils/utils.dart';
import 'package:hawker_merchant/widgets/widget.dart';
  ...
  void onPrivacy() {
    Navigator.pushNamed(
      ...
      arguments: WebViewModel(
        ...
        url: "https://www.hawkerpedia.com.sg/en/privacy-policy",
      ),
    );
  }
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                AppButton(
                                  Translate.of(context).translate('login_with_hawker'),
                                  icon: Image.asset(
                                    Images.iconRemovedBg,
                                    width: 24,
                                    height: 24,
                                  ),
                                  onPressed: onLogin,
